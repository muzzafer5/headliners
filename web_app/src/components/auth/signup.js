          ...
          <div className="shadow-lg card-body col-lg-5 col-sm-9 col-md-7 col-11 mx-auto" >
            ...
            <form validate="true" onSubmit={this.onSubmit}>
              ...
              <div className="card mx-3">
                <div className="card-body" style={{ textAlign: "justify", fontSize: "small" }}>
                    ...
                    <ul>
                      ...
                      <li>
                        You are also aware and authorizing that data gathered from
                        this app will be analyzed for research purposes to understand
                        more about human processes with social media and news headlines.
                    </li>
                      <li>
                        Review your cellular data usage to manage any related
                        fees related to this app.
                    </li>
                    </ul>
                </div>
              </div>
