          ...
          <form validate="true" onSubmit={this.onSubmit}>
            ...
            <div className="form-group my-3 mx-3">
              ...
              <select
                ...
                <option value='Working in Retail, Sales, Marketing, Manufacturing'>
                  Working in Retail, Sales, Marketing, Manufacturing
                </option>
            ...
            <div style={{ textAlign: "justify", border: "1px solid grey" }} className="my-3 mx-3 py-1 px-2">
              <b>Terms and Conditions:</b><br></br>
              By clicking, you are voluntarily participating in this game.
              You are also aware and authorizing that data gathered from this
              app will be analyzed for research purposes to understand more about
              human processes with social media and news headlines. Please review
              your cellular data usage to manage any related fees related to this app.
            </div>
